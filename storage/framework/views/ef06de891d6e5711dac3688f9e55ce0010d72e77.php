                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2.5 py-0.5 inline-flex text-xs font-medium rounded-full <?php echo e($user->role_id === 0 ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-800'); ?>">
                                        <?php echo e($user->role_id === 0 ? 'Administrator' : 'Standard User'); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-3">
                                        <button onclick="editUser(<?php echo e($user->id); ?>)" class="text-indigo-600 hover:text-indigo-900 bg-indigo-50 p-1.5 rounded-md hover:bg-indigo-100 transition-colors">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-5 transition-shadow hover:shadow-md">
                        <div class="flex justify-between items-start mb-4">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h4 class="font-bold text-gray-900 text-lg leading-tight"><?php echo e($user->name); ?></h4>
                                    <p class="text-xs text-gray-500 mt-0.5"><?php echo e($user->email); ?></p>
                                </div>
                            </div>
                            <span class="px-2.5 py-0.5 text-xs font-semibold rounded-full <?php echo e($user->role_id === 0 ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-800'); ?>">
                                <?php echo e($user->role_id === 0 ? 'Admin' : 'User'); ?>

                            </span>
                        </div>
                        
                        <div class="flex justify-end space-x-3 pt-4 border-t border-gray-100">
                            <button onclick="editUser(<?php echo e($user->id); ?>)" class="flex-1 inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none">
                            ...
                            <?php if(auth()->id() !== $user->id): ?>
                            <form action="<?php echo e(route('users.destroy', $user)); ?>" method="POST" class="flex-1 inline-block">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
    ...
    <script>
        ...
        function openUserModal(data = null) {
            ...
            if (data) {
                ...
                form.action = `<?php echo e(url('users')); ?>/${data.id}`;
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\invoice_reader\resources\views/users/index.blade.php ENDPATH**/ ?>